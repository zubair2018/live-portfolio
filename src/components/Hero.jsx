    ...
    <section id="home" className="relative isolate overflow-hidden bg-[#070b18] text-white">
      ...
      <div className="mx-auto flex min-h-[92vh] max-w-6xl flex-col justify-center px-5 py-28 sm:px-8 lg:px-10">
        <div className="max-w-4xl">
          ...
          <p className="mt-10 font-mono text-xs uppercase tracking-[0.3em] text-fuchsia-200/80">
            Developer · Designer · Creator
          </p>
          <h1 className="mt-5 text-5xl font-extrabold leading-[0.98] tracking-[-0.055em] sm:text-6xl lg:text-8xl">
            Digital experiences with{" "}
            <span className="gradient-text">clarity & character.</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            ...
            <a href="/resume.txt" download className="inline-flex min-h-[52px] items-center justify-center rounded-full border border-white/15 bg-white/[0.03] px-6 text-sm font-semibold text-white transition hover:border-fuchsia-300/60 hover:bg-white/[0.08]">
              Download résumé
            </a>
          </div>
        </div>
